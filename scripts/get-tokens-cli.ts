#!/usr/bin/env node
/**
 * get-tokens-cli.ts — decompose a symbol into tokens and annotate with definition locations
 *
 * Usage:
 *   lsprag getTokens --file <path> --symbol <name>
 *
 * Output:
...
if (!filePath || !symbolName) {
  console.error("Usage: lsprag getTokens --file <path> --symbol <name>");
  process.exit(1);
}
