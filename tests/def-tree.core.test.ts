...
const fixturePath = path.join(__dirname, "fixtures", "def-tree-sample.ts");
...
const document = createDocument("file:///fixture/def-tree-sample.ts", text);
...
console.log("PASS: buildDefTree core smoke test");
